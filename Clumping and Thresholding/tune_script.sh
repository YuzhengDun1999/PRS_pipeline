...
# --q-score-range: followed by range.file data.file (refer to CandT.R for details)
...
--score /dcs04/nilanjan/data/jialan/CT/beta_use.txt 1 2 header \
  ignore-dup-ids \
--score-col-nums 3 \
--q-score-range /dcs04/nilanjan/data/jialan/CT/range.txt /dcs04/nilanjan/data/jialan/CT/snp_pvalue.txt header \
--out /dcs04/nilanjan/data/jialan/CT/prs_tune/prs_tune_chr${SGE_TASK_ID} 
