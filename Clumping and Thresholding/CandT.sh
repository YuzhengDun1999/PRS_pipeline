...
# ----------------------- Linux commands -----------------------
module load conda_R
Rscript /dcs04/nilanjan/data/jialan/LDPred2/CandT.R ${SGE_TASK_ID} 1  
# Change directory here. ${SGE_TASK_ID} do not need to be changed. Example: Rscript /x/xx/xxx/CandT.R ${SGE_TASK_ID}. This specifies chromosome 1-22.
