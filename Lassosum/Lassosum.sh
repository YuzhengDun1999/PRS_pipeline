...
# ----------------------- Linux commands -----------------------
module load conda_R
Rscript /dcs04/nilanjan/data/ydun/PRS_pipeline/Lassosum/Lassosum.R ${SGE_TASK_ID} 1  
# Change directory here. ${SGE_TASK_ID} do not need to be changed. Example: Rscript /x/xx/xxx/Lassosum.R ${SGE_TASK_ID}. This specifies chromosome 1-22.
...
# Rscript /dcs04/nilanjan/data/jialan/LDPred2/Lassosum.R ${SGE_TASK_ID} 2
